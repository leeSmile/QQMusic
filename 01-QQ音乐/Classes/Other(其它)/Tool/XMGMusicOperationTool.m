...
@interface XMGMusicOperationTool()<AVAudioPlayerDelegate>
...
#pragma mark - 音乐播放代理方法

- (void)audioPlayerDidFinishPlaying:(AVAudioPlayer *)player successfully:(BOOL)flag
{
    if ([self.delegate respondsToSelector:@selector(musicDidFinish)]) {
        [self.delegate musicDidFinish];
    }
}
