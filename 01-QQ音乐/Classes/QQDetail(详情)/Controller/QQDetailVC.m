...
@interface QQDetailVC ()<UIScrollViewDelegate, XMGMusicOperationToolDelegate>
/**
 *  歌词背景滚动的视图
 */
...
-(void)viewWillAppear:(BOOL)animated
{
    ...
    [XMGMusicOperationTool sharedXMGMusicOperationTool].delegate = self;
}
...
-(void)viewDidDisappear:(BOOL)animated
{
    ...
    self.link = nil;
    [XMGMusicOperationTool sharedXMGMusicOperationTool].delegate = nil;
}
